    ...
    @Query(nativeQuery = true, value = """
        WITH vehicle_data AS (
            SELECT 
                ...
                CASE WHEN :sortField = 'lastVisitDate' THEN vs.last_visit_date END as sort_last_visit_date,
        ...
        SELECT 
            ...
            visit_count, last_visit_date, total_revenue, created_at, updated_at
        ...
        ORDER BY 
            ...
            CASE WHEN :sortDirection = 'ASC' THEN sort_last_visit_date END ASC,
            CASE WHEN :sortDirection = 'DESC' THEN sort_last_visit_date END DESC,
